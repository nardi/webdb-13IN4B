<div class="centered-container">
    ...
    <?php
        ...
        $query = "SELECT Producten.id, titel, cover, Producten.prijs, Aanbiedingen.prijs FROM Producten JOIN Aanbiedingen ON product_id = Producten.id WHERE verwijderd != 1";
