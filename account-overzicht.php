...
U bent niet ingelogd!
	...
	<?php
        ...
        $sql1 = $db->prepare("SELECT postcode, huisnummer, plaats, straat FROM Adressen WHERE id= '".$_SESSION['gebruiker-id']."' LIMIT 1");
        $sql1->execute();  
        $sql1->bind_result($postcode, $huisnummer, $plaats, $straat); 
