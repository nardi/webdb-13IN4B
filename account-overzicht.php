...
U bent niet ingelogd!
	...
	<?php
        ...
        $sql1 = $db->prepare("SELECT postcode, huisnummer, toevoeging, plaats, straat FROM Adressen WHERE gebruiker_id= '".$_SESSION['gebruiker-id']."' JOIN AdresGebruiker ON Adressen.id = adres_id  LIMIT 1");
        $sql1->execute();  
