			...
			<div class="product-toevoegen">
				<form method="post" enctype="multipart/form-data" onsubmit="testall()" action="javascript:void(0)">
				  ...
				  <h1><center><b>Product toevoegen</b></center></h1>
					  ...
					  Release date: <input type="text" id="release_date" name="release_date" onblur="checkDatum('release_date','releaselabel')"><div id='releaselabel' class='label' value="jjjj-mm-dd" onclick="emptydate()"></div><br />
