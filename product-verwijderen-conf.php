                ...
                <div id='ja'>
                    <form id='DeleteItemConf' action='products.php' method='post'>
                        <div id='ItemVerwijderen'>
                            <input type='submit' value='Ja' name='submitButtonYes' id='DeleteSubmitButton' title='Product verwijderen'/>
                        </div>
                    </form>
                </div>
                <div id='nee'>
                    <form id='backToProduct' action='redirect_to(item-description.php?id=$pid)' method='post'>
                        <div id='ItemNietVerwijderen'>
                            <input type='submit' value='Nee' name='submitButtonNo' id='DeleteSubmitButton' title='Product verwijderen'/>
                        </div>
                    </form>
                </div>
            </div>";
