...
//production
define('DBSERVER', 'websec.science.uva.nl');
define('DBNAME', 'stdwebp39');
define('USER_WRITE', 'stdwebp39');
define('PASS_WRITE', 'vipj_0uV');
define('USER_READ', 'stdwebp39');
define('PASS_READ', 'vipj_0uV');
//testing
/*
...
class mymysqli {
    ...
    private $pass_read = PASS_READ;      //(string) database password for read-only user
