<?php
    ...
    if (isset($_REQUEST['naam']))  {
        ...
        while ($sqli->fetch()) {  
            ...
            ?>
                <option value=1 <?phpif($status == 1){ echo 'selected="selected"';}?> >Ongeverifiëerd</option>
                <option value=2 <?phpif($status == 2){ echo 'selected="selected"';}?> >Geverifiëerd</option> 
                <option value=3 <?phpif($status == 3){ echo 'selected="selected"';}?> >Medewerker</option>
                <option value=4 <?phpif($status == 4){ echo 'selected="selected"';}?> >Beheerder</option>
                </select></td>
            <?php
