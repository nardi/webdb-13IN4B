    ...
    if (isset($_REQUEST['naam']))  {
        ...
        while ($sqli->fetch()) {  
            ...
            ?>
                ...
                <option value=2  <?phpif($status == 1) echo ' .selected.';?> >Geverifiëerd</option> 
                <option value=3  <?phpif($status == 1) echo ' .selected.';?> >Medewerker</option>
                <option value=4  <?phpif($status == 1) echo ' .selected.';?> >Beheerder</option>
                </select></td>
            <?php
