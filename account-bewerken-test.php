...
U bent niet ingelogd!
    ...
    function SqlThatShit(){
        $sqli_gebruikers = $db->prepare("UPDATE Gebruikers SET naam='$voornaam', achternaam=$achternaam, telefoonnummer=$telefoonnummer, email=$emailadres WHERE id= '".$_SESSION['gebruiker-id']."' ");
